...
public class AddressBook {
  ...
  // --------------------------------------------------------
  // Suche alle Namens in einer Stadt
  // --------------------------------------------------------
  public static void suche(Scanner sc, Address[] addresses) {
    System.out.println("----- Suche Adressen -----");
    System.out.print("Stadt: ");
    String city = sc.next();

    for (Address address : addresses) {
      if (address != null && address.getCity() != null && address.getCity().equals(city)) {
  ...
  public static void main(String[] args) {
    ...
    while (!done) {
      ...
      switch (choice) {
        ...
        case 4 -> suche(scanner, addresses);
        case 9 -> done = true;
